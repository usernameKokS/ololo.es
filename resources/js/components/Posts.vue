  ...
  <div>
      ...
      <div class="posts-content">
        <div class="container">
          <div class="post-main-wrap" v-for="post in posts" :key="'postof' + post.id">
                ...
                <div class="item-content">
                  <div class="item-content__left">
                                ...
                                <div class="item_desc" style="padding-bottom: 0;">
                                    <div class="item_desc-left" style="width: 232px;">
                                        <p>
                                            Tu tarifa:
                                            <span>
                              <span class="item_desc-success tarifa-name" v-if="post.tarifa != 'No'">{{ post.tarifa }}</span>
                              <span class="item_desc-error tarifa-name" v-else>{{ post.tarifa }}</span>
                                      ...
                                      'colorpay__red': post.colorpay == 'red'}"
                                        ...
                                        <div class="wrap-btn-mobile-inline" style="margin-bottom: 15px; margin-top: 15px;" v-if="post.archive == false">
                                            ...
                                            >
                                                <div>
                                                    <img src="/img/icon-success.svg" style="width: 20px; height: 20px; margin-right: 5px;">
                                                    <span >ACTIVAR</span>
                                                </div>
                                            </a>
                                            <a
                                            ...
                                            >
                                                <div>
                                                    <img src="/img/money.svg" style="width: 20px; height: 20px; margin-right: 5px;">
                                                    <span>PAGAR</span>
                                                </div>
                                            </a>
                                        </div>
                            ...
                            <div class="item-content__right" style="justify-content: flex-start; z-index:400;" v-if="post.archive == false">
                                <div class="wrap-btn-mobile-inline disable-desk" style="margin-bottom: 15px; margin-top: 84px;">
                                    ...
                                    >
                                        <div>
                                            <img src="/img/money.svg" style="width: 20px; height: 20px; margin-right: 5px;">
											                      <span style="margin-right: 5px;">PAGAR</span>
                                        </div>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="item-content__bottom disable-md-down">
                      ...
                      <div class="wrap-btn-mobile-inline">
                        <a :href="'/dashboard?site=Todos&postid=' + post.id" class="btn btn-normal btn_green-hover non-fixed-btn18">
                          <div>
                  ...
                  <div v-show="archive != true" class="item-content__right disable-desk" style="z-index: 400">
            ...
            <div class="post-item__dissable container" v-if="post.publish == false || post.end_pay == null || post.tarifa == 'No'">
            ...
            <div class="no-posts" v-if="emptyPost && archive === false">
                <div class="container container-two">
                    ...
                    <p style="color: #fe6885;">Todavía no has publicado anuncios. Puedes publicarlos desde el menú principal.</p>
                    <div class="wrap-btn-mobile-inline">
        ...
        <div class="modal-container">
          <div class="modal-body">
            <div class="notify-area">
              <p>
                  Al eliminar el anuncio, se dejarán de mostrar todos tus anuncios en los diferentes portales y el anuncio pasa a la sección de "eliminados".
                  <br>
                  ¿ Seguro que quieres eliminar el anuncio?

                  <div class="alert alert-info" v-if="!this.isCanDelete">
                    Durante la tarifa  solo puedes modificar tus anuncios una vez. Te queda <b>{{getCountDelete}}</b> eliminacion/es.
                  </div>
              </p>
    ...
    <modal name="activeModal" :adptive="true" width="380" height="auto">
      <div class="appmodal notify-modal">
        <div class="modal-container">
          <div class="modal-header modal-header-notify">
            <img v-if="status == 1" src="/img/delete.svg" alt="icon" class="handleimg" @click="hideActiveModal" />
        ...
        <div class="modal-container">
          <div class="modal-body">
            <div class="notify-area">
              <p v-if="status == 1">
                  Al desactivar el anuncio, se dejarán de mostrar todos tus anuncios en los diferentes portales y el anuncio se quedará desactivado.
                  <br>
