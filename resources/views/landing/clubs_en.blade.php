...
<div id="__next">
                                ...
                                <div class="mainRow___l31cR">
                                    ...
                                    <div class="appsLinks___367vX control-mobile">
                                        <a class="app___1zJo4 app___4YV-O w-120 color-green animated infinite bounce"
                                           href="/personal" target="_blank">To sign up</a>
                                    </div>
									@endguest
                                    <div class="navigation___RqU5O">
										@auth
										<div class="control___26dei link___24nhA custom">
											<div>Your email:</div><a href="/personal" class="nav-link">{{auth()->user()->email}}</a>
										</div>
										@endauth
                                            ...
                                            <div class="navigation___29KkF isExternal___279Bc navigationInner___3gerk">
                                                <ul class="navigationItems___3kw85">
                                                    <li class="navigationItem___2fRbs">
                                                        <a href="{{route('landing')}}" class="control___26dei link___24nhA isHighlighted___2n3nd isExternal___279Bc isLanding___JPwTH">Independent</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </nav>
  ...
  overflow: hidden; transform: rotate(180deg)" src="{{asset('/assets/img/slide/vid.jpg')}}"/></span>
                                        ...
                                        <div class="content___3vwxh">
                                            <div class="title___3ftGr title-f-pc">Increase traffic to your Club or brothel.
                                            </div>
                                            <div class="description___X_eXQ comp_butone">Promote girls / travesties automatically on more than 40 sex portals in Spain. Also, get reviews on the best sex forums.
                                            </div>
                                                ...
                                                <div class="buttonsSet___3JySY"
                                                    ...
                                                    <div class="actionContainer___12YyA">
                                                        <a
                                                            ...
                                                            <span class="label___3lOm1">Start</span></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="mob_buttone">
                                        <div class="description___X_eXQ">Promote girls / travesties automatically on more than 40 sex portals in Spain. Also, get reviews on the best sex forums.
                                        </div>
                        ...
                        <div
                            ...
                            <div class="pageSectionTitle___3BR-9 title___3hHPI"><span>Manage all the profiles of your girls/trans with just 1 account! </span>
                            </div>
                        ...
                        <div
                            ...
                            <div class="pageSectionTitle___3BR-9 magn">How does it work</div>
                            <div class="content___s6hxn">
                                            ...
                                            <div class="header___3p1Hx">
                                                <div>
                                                    ...
                                                    <h4 class="subtitle___WRXmU spec-landing-promo-step-item-subtitle">
                                                        Sign up as a Club or brothel.</h4>
                                                    <p class="caption___2Ofm- spec-landing-promo-step-item-caption">To have a special rate and have complete statistics.</p>
                                                </div>
                                        ...
                                        <div class="promoStepItem____eHAl spec-landing-promo-step-item">
                                            <div class="header___3p1Hx">
                                                <div>
                                                    ...
                                                    <h4 class="subtitle___WRXmU spec-landing-promo-step-item-subtitle">
                                                        Upload the profiles to the system only once.</h4>
                                                    <p class="caption___2Ofm- spec-landing-promo-step-item-caption">
                                                        Fill in the information and add the photos.</p>
                                                </div>
                                                <div class="iconsSet___3BDGz spec-landing-promo-step-item-icon">
                                                    <svg viewBox="0 0 48 48" fill="#000000" width="48" height="48"
                                                         xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div class="promoStepItem____eHAl spec-landing-promo-step-item">
                                            <div class="header___3p1Hx">
                                                <div>
                                                    ...
                                                    <h4 class="subtitle___WRXmU spec-landing-promo-step-item-subtitle">
                                                        Select the targeted advertising platforms.</h4>
                                                    <p class="caption___2Ofm- spec-landing-promo-step-item-caption">
                                                        Example: passion.com, mileroticos, slumi, hott.es, adultguia.com, skokka.com, etc</p>
                                                </div>
                                                <div class="iconsSet___3BDGz spec-landing-promo-step-item-icon">
                                                    <svg viewBox="0 0 48 48" fill="#000000" width="48" height="48"
                                                         xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div class="promoStepItem____eHAl spec-landing-promo-step-item">
                                            <div class="header___3p1Hx">
                                                <div>
                                                    ...
                                                    <h4 class="subtitle___WRXmU spec-landing-promo-step-item-subtitle">
                                                        Choose an optimal rate</h4>
                                                    <p class="caption___2Ofm- spec-landing-promo-step-item-caption">
                                                        Select the rate and start publishing.</p>
                                                </div>
                                                <div class="iconsSet___3BDGz spec-landing-promo-step-item-icon">
                                                    <svg viewBox="0 0 48 48" fill="#000000" width="48" height="48"
                                                         xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div class="promoStepItem____eHAl spec-landing-promo-step-item">
                                            <div class="header___3p1Hx">
                                                <div>
                                                    ...
                                                    <h4 class="subtitle___WRXmU spec-landing-promo-step-item-subtitle">
                                                        Choose forums where you would like to have reviews about the girls / travesties </h4>
                                                    <p class="caption___2Ofm- spec-landing-promo-step-item-caption">
                                                        Example: sexomercadobcn.com, spalumi.com, etc.</p>
                                                </div>
                                                <div class="iconsSet___3BDGz spec-landing-promo-step-item-icon">
                                                    <svg viewBox="0 0 48 48" fill="#000000" width="48" height="48"
                                                         xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div class="promoStepItem____eHAl cols2___2nfE3 spec-landing-promo-step-item">
                                            <div class="header___3p1Hx header___3CYyd">
                                                <div>
                                                    ...
                                                    <h4 class="subtitle___WRXmU spec-landing-promo-step-item-subtitle">
                                                        Start receiving calls.</h4>
                                                    <h4 class="subtitle___WRXmU subtitle___1akVl spec-landing-promo-step-item-subtitle">
                                                        Forget about wasting time on each portal, now you can do it from just 1 website.</span>
                                                    </h4>
                                                </div>
                                            </div>
                                            <div
                                                class="content___3xvNM content___Nodj1 spec-landing-promo-step-item-content">
                                                <div class="title___1phnF">Forget about wasting time on each portal, now you can do it from just 1 website.
                                                </div>
                                ...
                                <div class="advantages___34T17">
                                    <div class="advantageItem___bi5Gk">
                                        ...
                                        <div class="advantageItemContent___17QNX">The ads are posted where your prime audience is.
                                        </div>
                                    </div>
                                    <div class="advantageItem___bi5Gk">
                                        <div class="advantageItemIconsSet___F3vkR">
                                        ...
                                        <div class="advantageItemContent___17QNX">We use the latest technologies to facilitate routine work.
                                        </div>
                                    </div>
                                    <div class="advantageItem___bi5Gk">
                                        <div class="advantageItemIconsSet___F3vkR">
                                        ...
                                        <div class="advantageItemContent___17QNX">You do not have to worry about anything, all processes are automatic and are verified by qualified personnel.
                                        </div>
                                    </div>
                                </div>
                                <div class="chartSample___2NCHl">
                                    <h3 class="title___1_82t displayOnSmallMediaFormat___3OwBw">And most importantly, the results are measurable and success quantifiable.</h3>
                                    ...
                                    <div class="info___1zHQz">
                                        <h3 class="title___1_82t hideOnSmallMediaFormat___2CvCI">The importance of visualizations:<br></h3>
                                        <p class="caption___Ok8W0">The statistics of your posted ads are always available.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div
                            ...
                            <div class="pageSectionTitle___3BR-9 mobbb">Examples</div>
                                                ...
                                                <div class="content___Rhi-W ">
                                                    <div class="creative___3Q-7n">
                                                        ...
                                                        <div class="info___39yI7">
                                                            ...
                                                            <div class="caption___8YcAa">Pasion es is the most popular contact ad website in Spain. More than sixteen thousand advertisements are published daily on pasion.com
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="statistic___ROn2a">
                                                        <div class="caseStatisticItem___WL4Tk">
                                                            ...
                                                            <div class="value___1nKhW">659,759</div>
                                                            <div class="label___2cvVl">Times seen</div>
                                                        </div>
                                                        <div class="caseStatisticItem___WL4Tk">
                                                            <div class="icon___3qNne" style="color:#25d366">
                                                                <svg viewBox="0 0 48 48" fill="#000000" width="48"
                                                            ...
                                                            <div class="label___2cvVl">Phone displayed</div>
                                                        </div>
                                                        <div class="caseStatisticItem___WL4Tk">
                                                            <div class="icon___3qNne" style="color:#25d366">
                                                                <svg viewBox="0 0 48 48" fill="#000000" width="48"
                                                            ...
                                                            <div class="label___2cvVl">Email sending</div>
                                                        </div>
                                                        <div class="caseStatisticItem___WL4Tk">
                                                            <div class="icon___3qNne" style="color:#25d366">
                                                                <svg viewBox="0 0 48 48" fill="#000000" width="48"
                                                            ...
                                                            <div class="label___2cvVl">Increase your sales</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="content___Rhi-W">
                                                    <div class="creative___3Q-7n">
                                                        ...
                                                        <div class="info___39yI7">
                                                            ...
                                                            <div class="caption___8YcAa">A portal with high efficiency in the world of escorts and whores in Spain.
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="statistic___ROn2a">
                                                        ...
                                                        <div class="caseStatisticItem___WL4Tk">
                                                            ...
                                                            <div class="value___1nKhW">605</div>
                                                            <div class="label___2cvVl">Phone displayed</div>
                                                        </div>
                                                        <div class="caseStatisticItem___WL4Tk">
                                                            <div class="icon___3qNne" style="color:#000000">
                                                ...
                                                <div class="content___Rhi-W">
                                                    <div class="creative___3Q-7n">
                                                        ...
                                                        <div class="info___39yI7">
                                                            ...
                                                            <div class="caption___8YcAa">A pioneering website for Escorts, whores, and transvestites that offers sex and erotic massages.
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="statistic___ROn2a">
                                                        ...
                                                        <div class="caseStatisticItem___WL4Tk">
                                                            ...
                                                            <div class="value___1nKhW">+63%</div>
                                                            <div class="label___2cvVl">Increase your sales</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="content___Rhi-W">
                                                    <div class="creative___3Q-7n">
                                                        ...
                                                        <div class="info___39yI7">
                                                            ...
                                                            <div class="caption___8YcAa">Mileroticos.com specializes in erotic advertisement web pages for escorts or whores, transvestites, erotic massages.
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="statistic___ROn2a">
                                                        ...
                                                        <div class="caseStatisticItem___WL4Tk">
                                                            ...
                                                            <div class="value___1nKhW">874</div>
                                                            <div class="label___2cvVl">Phone displayed</div>
                                                        </div>
                                                        <div class="caseStatisticItem___WL4Tk">
                                                            <div class="icon___3qNne" style="color:#003b6b">
                                                ...
                                                <div class="content___Rhi-W">
                                                    <div class="creative___3Q-7n">
                                                        ...
                                                        <div class="info___39yI7">
                                                            ...
                                                            <div class="caption___8YcAa">Erosguia has been working since 2004 to offer the classified ad portal with the best escorts and transvestites. Being a great power in Barcelona and Madrid and with a notable presence in the rest of Spain.
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="statistic___ROn2a">
                                                        ...
                                                        <div class="caseStatisticItem___WL4Tk">
                                                            ...
                                                            <div class="value___1nKhW">1131</div>
                                                            <div class="label___2cvVl">Phone displayed</div>
                                                        </div>
                                                        <div class="caseStatisticItem___WL4Tk">
                                                            <div class="icon___3qNne" style="color:#000000">
                        ...
                        <div class="pageSection___DO-C- homepageSection___KmXBl isRevealed___39VSj"
                            ...
                            <div class="pageSectionTitle___3BR-9 slid">We work with the following portals:</div>
                        ...
                        <!--div
                            ...
                            <div class="content___s6hxn">
                                <div class="samplesGrid___2pT4o">
                                    <div class="samplesGridTitle___k5uBo"><span>Still have doubts?</span></div>
                                        ...
                                        <div
                                            ...
                                            <a class="link___3B3Hd" href="#" target="_blank"
                                               style="text-decoration: none">
                                                ...
                                                <div class="title___TGhfe">Download our presentation.</div>
                                                <div class="content___1MiK_">Get a pdf with information on how the web works.
                                                </div>
                                            </a></div>
                        ...
                        <div class="links___3p36H">
                            <nav class="secondaryNavigation___3e7GY">
                                ...
                                <div class="secondaryNavigationItem___KRXjT"><a
                                        ...
                                        href="/download/policy.pdf" target="_blank">Cookie Policy</a>
                                </div>
                            </nav>
                            <div class="support___2KWZQ">Got question? Write us at    clubs@almejarosa.com</div>
                        </div>
