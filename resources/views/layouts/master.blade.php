...
<head>
    ...
    @if(env('APP_ENV') == 'production')
        ...
        <noscript>
            <div><img src="https://mc.yandex.ru/watch/67951603" style="position:absolute; left:-9999px;" alt=""/></div>
        </noscript>
    @endif
    <!-- /Yandex.Metrika counter
    <script>
            ...
            <div class="modal-container">
                <div class="modal-body">
                    <div class="notify-area">
                        ...
                        <button class="btn btn-regular btn_green-hover btn-width-set" @click="forgotPass()"
                                :disabled="waitSend">
                            <div>
                                <span>CONFIRMAR</span>
                            </div>
...
<script src="{{ mix('/js/app.js') }}?r={{ date("Ymd") }}"></script>
